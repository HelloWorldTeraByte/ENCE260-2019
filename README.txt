How to upload:
    1) First connect the UCFK to a computer
    2) The UCFK must be put into reset mode for the porgramming, This is done by pressing S1
    2) Go into the directory location /assigment/group406
    3) Run command make proram to program the UCFK
...
How to play the game.
        ...
        controls
            ...
            making a Jap: press the analoge stick would form an X pattern. 
        2)Details:
        ...
        3)  Health:
           -) you will see a blue led blinking indicating that's the player health. 
